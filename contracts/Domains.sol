...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld)
        payable
        ERC721("Plato Name Service", "PLATO")
    {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        _name,
                        '", "description": "A domain on the Plato name service exclusively for OneMillionSignature DAO NFT holders.", "image": "data:image/svg+xml;base64,',
